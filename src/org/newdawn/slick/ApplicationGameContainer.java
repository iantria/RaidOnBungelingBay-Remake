 ...
 * @author kevin
 */
public class ApplicationGameContainer extends GameContainer {
	static {
  ...
  public int preferredHeight;
	 ...
	 */
	public ApplicationGameContainer(Game game) throws SlickException {
	 ...
	 * @throws SlickException Indicates a failure to initialise the display
	 */
	public ApplicationGameContainer(Game game,int width,int height,boolean fullscreen) throws SlickException {
		super(game);
...
//	}
	...
	public void setDisplayMode(int width, int height, boolean fullscreen) throws SlickException {
        ...
        int error = Integer.MAX_VALUE;
            ...
            int dw = current.getWidth() - width;
            int dh = current.getHeight() - height;
            int currentError = dw * dw + dh * dh;
	...
	public void setFullscreen(boolean fullscreen) throws SlickException {
        ...
        Display.setDisplayMode(
            new DisplayMode(preferredWidth, preferredHeight));
