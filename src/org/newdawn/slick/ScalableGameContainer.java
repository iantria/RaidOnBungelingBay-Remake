 ...
 * @author kevin
 */
public class ScalableGameContainer extends Applet {
  ...
  public void start() {
      ...
      gameThread = new Thread() {
         public void run() {
            try {
               ...
               e.printStackTrace();
               ScalableGameContainer.this.destroy();
   ...
   public void init() {
      ...
      try {
         ...
         int gameWidth = Integer.parseInt(getParameter("game_width"));
         int gameHeight = Integer.parseInt(getParameter("game_height"));
         
         container = new Container(
             new ScalableGame(game, gameWidth, gameHeight, true));
   ...
   public class Container extends GameContainer {
      ...
      public Container(Game game) {
         ...
         width = ScalableGameContainer.this.getWidth();
         height = ScalableGameContainer.this.getHeight();
      }
      ...
      public Applet getApplet() {
         return ScalableGameContainer.this;
      }
